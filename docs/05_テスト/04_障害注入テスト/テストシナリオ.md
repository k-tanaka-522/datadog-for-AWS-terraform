...
# 式: (L3-Health-tenant-a || L3-Error-tenant-a || L3-Latency-tenant-a) && NOT L0-Composite && NOT L2-Composite → Composite ALERT
```
...
**ステップ10: 全Monitor正常確認**
```bash
# 全Monitor（L0: 7個、L2: 2個、L3: 9個、Composite: 3個）のステータス: OK
